...
# curriculum_recommendations documentation build
...
from curriculum_recommendations import __version__ as release

# -- Project information -----------------------------------------------------

project = "curriculum_recommendations"
author = "Kedro"
...
htmlhelp_basename = "curriculum_recommendationsdoc"
...
latex_documents = [
    (
        master_doc,
        "curriculum_recommendations.tex",
        "curriculum_recommendations Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "curriculum_recommendations",
        "Project curriculum_recommendations codebase.",
        "Data-Science",
    )
]
